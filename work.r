...
APR2012df = crime[1:sum(crime$Month == "4" & crime$Year == "2012"),]
MAY2012df = crime[1:sum(crime$Month == "5" & crime$Year == "2012"),]
JUN2012df = crime[1:sum(crime$Month == "6" & crime$Year == "2012"),]
JLY2012df = crime[1:sum(crime$Month == "7" & crime$Year == "2012"),]
AUG2012df = crime[1:sum(crime$Month == "8" & crime$Year == "2012"),]
SEP2012df = crime[1:sum(crime$Month == "9" & crime$Year == "2012"),]
OCT2012df = crime[1:sum(crime$Month == "10" & crime$Year == "2012"),]
...
APR2013df = crime[1:sum(crime$Month == "4" & crime$Year == "2013"),]
MAY2013df = crime[1:sum(crime$Month == "5" & crime$Year == "2013"),]
JUN2013df = crime[1:sum(crime$Month == "6" & crime$Year == "2013"),]
JLY2013df = crime[1:sum(crime$Month == "7" & crime$Year == "2013"),]
AUG2013df = crime[1:sum(crime$Month == "8" & crime$Year == "2013"),]
SEP2013df = crime[1:sum(crime$Month == "9" & crime$Year == "2013"),]
OCT2013df = crime[1:sum(crime$Month == "10" & crime$Year == "2013"),]
...
APR2014df = crime[1:sum(crime$Month == "4" & crime$Year == "2014"),]
MAY2014df = crime[1:sum(crime$Month == "5" & crime$Year == "2014"),]
JUN2014df = crime[1:sum(crime$Month == "6" & crime$Year == "2014"),]
JLY2014df = crime[1:sum(crime$Month == "7" & crime$Year == "2014"),]
AUG2014df = crime[1:sum(crime$Month == "8" & crime$Year == "2014"),]
SEP2014df = crime[1:sum(crime$Month == "9" & crime$Year == "2014"),]
OCT2014df = crime[1:sum(crime$Month == "10" & crime$Year == "2014"),]
...
APR2015df = crime[1:sum(crime$Month == "4" & crime$Year == "2015"),]
MAY2015df = crime[1:sum(crime$Month == "5" & crime$Year == "2015"),]
JUN2015df = crime[1:sum(crime$Month == "6" & crime$Year == "2015"),]
JLY2015df = crime[1:sum(crime$Month == "7" & crime$Year == "2015"),]
AUG2015df = crime[1:sum(crime$Month == "8" & crime$Year == "2015"),]
SEP2015df = crime[1:sum(crime$Month == "9" & crime$Year == "2015"),]
OCT2015df = crime[1:sum(crime$Month == "10" & crime$Year == "2015"),]
...
APR2016df = crime[1:sum(crime$Month == "4" & crime$Year == "2016"),]
MAY2016df = crime[1:sum(crime$Month == "5" & crime$Year == "2016"),]
JUN2016df = crime[1:sum(crime$Month == "6" & crime$Year == "2016"),]
JLY2016df = crime[1:sum(crime$Month == "7" & crime$Year == "2016"),]
AUG2016df = crime[1:sum(crime$Month == "8" & crime$Year == "2016"),]
SEP2016df = crime[1:sum(crime$Month == "9" & crime$Year == "2016"),]
OCT2016df = crime[1:sum(crime$Month == "10" & crime$Year == "2016"),]
NOV2016df = crime[1:sum(crime$Month == "11" & crime$Year == "2016"),]
DEC2016df = crime[1:sum(crime$Month == "12" & crime$Year == "2016"),]
